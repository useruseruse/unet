...
# 메인 함수
def main(image_path1, image_path2, model_path):
...
if __name__ == "__main__":
    image_path1 = "../data/redirect/19MA120425KI_1_60.jpg"
    image_path2 = "../data/redirect/19OE120736KI_1_100.jpg"
    path_to_model = "./model/model_checkpoint.pth"

    main(image_path1, image_path2, path_to_model)
